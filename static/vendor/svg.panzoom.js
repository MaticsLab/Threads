/*! svg.panzoom.js v2.0.3 (adapted)
 * Vendored from https://github.com/inkstitch/svg.panzoom.js (MIT, (c) Ulrich-Matthias Schäfer).
 * Adapted for the browser global SVG build: the ESM import is replaced by
 * destructuring from window.SVG so it loads with a plain <script> tag.
 */
(function () {
'use strict'
  var Svg = SVG.Svg, on = SVG.on, off = SVG.off, extend = SVG.extend, Matrix = SVG.Matrix, Box = SVG.Box
